                ...
                <tbody>
                    ...
                    @empty
                        <x-empty-row
                            colspan="6"
                            icon="fa-warehouse"
                            :title="__('No warehouses yet')"
                            :message="__('Stock is counted per warehouse, so you need at least one before anything can be received.')"
                            :create-url="route('warehouses.create')"
                            :create-label="__('Add Warehouse')"
                        />
                    @endforelse
                </tbody>
            </table>
