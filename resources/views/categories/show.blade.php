...
@section('subtitle', 'View category information')

@section('content')

    <div class="breadcrumb">
        <a href="{{ url('/categories/index') }}">Categories</a> <i class="fa-solid fa-chevron-right" style="font-size:9px"></i> <span>{{ $category->name }}</span>
    </div>
