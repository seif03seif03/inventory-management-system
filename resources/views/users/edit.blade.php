...
@section('subtitle', 'Update user details and role assignment')
    ...
    <div class="card" style="max-width: 680px;">
        <div class="card-header">
            <div>
                ...
                <p>Modify user information or change password</p>
            </div>
            ...
            <form action="{{ route('users.update', $user) }}" method="POST">
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group full" style="border-top: 1px solid var(--color-border); padding-top: 16px; margin-top: 4px;">
                        <label for="password">New Password <span class="hint">(Leave blank to keep existing password)</span></label>
                        <input
                            type="password"
                            id="password"
                            name="password"
